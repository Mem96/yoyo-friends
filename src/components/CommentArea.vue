<template>
  <div class="comment-area">
    <div class="comment-container">
      <div
        v-for="singleComment in storeComments.comments"
        :key="singleComment.id"
      >
        <div
          class="single-comment"
          v-if="singleComment.videoId == this.videoId"
        >
          <p class="comment-infos">
            <span>{{ singleComment.username }}</span> on
            {{ singleComment.time }} wrote:
          </p>
    ...
    <form>
      <div class="form-bars">
        <input
          ...
          v-model="this.newComment.username"
        />
        <span class="missing" v-if="this.commentMissing"
          ><em>Write a comment first!</em></span
        >
        <textarea
          class="comment-bar"
          :placeholder="this.commentPlaceholder"
          v-model="this.newComment.commentText"
        ></textarea>
